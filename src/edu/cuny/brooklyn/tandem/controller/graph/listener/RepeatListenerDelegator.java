...
public class RepeatListenerDelegator 
{
    ...
    private final Runnable mainRunnable_;
    ...
    public RepeatListenerDelegator(DistanceList distances, JFrame frame, JPanel mainPanel, Runnable mainRunnable) 
    {
        distances_ = distances;
        frame_ = frame;
        mainPanel_ = mainPanel;
        mainRunnable_ = mainRunnable;
    ...
    {
        Distance distance = distances_.getSelectedDistance();
        if(distance != null)
        {
            DistanceInformation distanceInformation = distance.getDistanceInformation();
