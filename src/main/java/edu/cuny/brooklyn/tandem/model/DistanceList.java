...
public class DistanceList extends AbstractList<Distance>
{
	...
	public void load()
	{
		...
		logger_.debug("Loading list from chromosome: " + chromosome_);
		distances_.clear();
	...
	{
		for(Chromosome chromosome: JdbcTandemDao.getInstance().getAllChromosomes())
		{
			if(chromosomeName.equals(chromosome.getName()))
			{
				setChromosome(chromosome);
				return;
			}					
		}
		throw new RuntimeException(chromosomeName + " not found in the database!");
	}
