...
public class GraphRangeSelector extends MouseAdapter implements MouseMotionListener
{
	...
	public GraphRangeSelector(final JPanel panel, Runnable runnable,
	...
	private int scalePoint(int point)
	{
		...
		double scale = ((double) limitedRange_.getLocal().getSize())
		/ barWidth_;
	...
	{
		if (e.getY() < barY1_ || e.getY() > barY2_ ||
				e.getX() < barX1_ || e.getX() > barX2_)
			return;
