...
public class NavigatorToolbar extends JToolBar implements ActionListener
{
	...
	public NavigatorToolbar(
			TextRangeSelectorController textRangeSelectorController,
			...
			GraphShifterView shifterView)
	{
		...
		textRangeSelectorView_ = new TextRangeSelectorView(
				textRangeSelectorController.getLimitedRange(),
				textRangeSelectorController);
