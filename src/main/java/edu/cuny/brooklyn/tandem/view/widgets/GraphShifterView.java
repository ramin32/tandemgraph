...
public class GraphShifterView extends JPanel implements ActionListener
{
	...
	public GraphShifterView(GraphShifterController graphShifterController)
	{
		...
		shiftRight_ = SwingUtil.createJButtonfromImgUrl(getClass().getClassLoader().getResource(
				"Forward24.gif"));
		shiftLeft_ = SwingUtil.createJButtonfromImgUrl(getClass().getClassLoader().getResource(
				"Back24.gif"));
