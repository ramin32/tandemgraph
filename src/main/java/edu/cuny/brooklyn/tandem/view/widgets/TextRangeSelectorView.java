/***********************************************************************
 * TextualRangeSelectorView.java
 *
 * Extends JToolBar, adds 2 text fields depicting starting and 
 * ending points of a range and zoom button. Modifies the LimitedRange
 * object of the containing panel and repaints it upon an action.
 *
 * Author:
 * Ramin Rakhamimov
 * ramin32@gmail.com
...
public class TextRangeSelectorView extends JPanel implements ActionListener
{
	...
	public TextRangeSelectorView(LimitedRange range,
			TextRangeSelectorController textualRangeSelectorController)
	{
		limitedRange_ = range;
